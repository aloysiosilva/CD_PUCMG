...
##########################################################################
# 1) Nível Superior x PIB Per Capita 
##########################################################################
...
X = pop_nivel_instr_pib.iloc[:,4] # 5º coluna: Percent_Sem_Instr - variável preditora
Y = pop_nivel_instr_pib.iloc[:,5] # 6ª coluna: PIB - variável resposta
...
plt.plot(X_test, regressor.predict(X_test), color = 'blue', scaley=False)
...
previsao_pib = regressor.predict([[60]])
previsao_pib
